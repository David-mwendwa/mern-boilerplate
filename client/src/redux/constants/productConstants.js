...
export const REVIEW_IS_ALLOWED_REQUEST = 'REVIEW_IS_ALLOWED_REQUEST';
export const REVIEW_IS_ALLOWED_SUCCESS = 'REVIEW_IS_ALLOWED_SUCCESS';
export const REVIEW_IS_ALLOWED_FAIL = 'REVIEW_IS_ALLOWED_FAIL';
